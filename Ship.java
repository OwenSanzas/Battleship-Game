...
public abstract class Ship {
    ...
    /**
     * If the surrounding of an end point(tail) of a ship has other ships, return false. Otherwise, return true.
     * @param row: row of the bow point
     * @param col: col of the bow point
     * @param isHorizontal: orientation of the bow point
     * @param ocean: the ocean map
     */
    ...
    /**
     * If the surrounding of an end point(tail) of a ship has other ships, return false. Otherwise, return true.
     * @param row: row of the end point
     * @param col: col of the end point
     * @param isHorizontal: orientation of the end point
     * @param ocean: the ocean map
     */
    ...
    /**
     * Check whether the surrounding points of a specific point is occupied by other ships
     * return true is the surrounding has no ship, false otherwise.
     * @param point: an array with 2 elements: point[0] is row and point[1] is column
     * @param ocean: the ocean map
     */
     ...
     * @param row: the row of the position where you want to place your ship
     * @param column: the column of the position where you want to place your ship
     * @param horizontal: A boolean that represents whether the ship is going to be placed horizontally or vertically
     * @param ocean: the ocean map
     */
     ...
     * @param row: the row of the position which is hit
     * @param column: the column of the position which is hit
    */
